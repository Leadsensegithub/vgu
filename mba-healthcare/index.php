...
<head>
    ...
    <!-- Favicon -->
     ...
     <link rel="canonical" href="https://iop.onlinevgu.com/mba-healthcare/" />
    <title>An Online MBA in Healthcare Management | VGU a degree Programs.</title>
    <meta name="title" content="An Online MBA in Healthcare Management | VGU a degree Programs." />
    ...
    <meta name="keywords" content="Online MBA in Healthcare Management,VGU Online MBA Healthcare,
Healthcare Administration MBA Online,Vivekananda Global University MBA Healthcare,MBA in Hospital and Health Systems Management,
Distance MBA in Healthcare,Online MBA Healthcare Program India,VGU Healthcare MBA Admission,
Health Services Management MBA Online,MBA in Public Health and Healthcare Online">
    <meta property="og:title" content="An Online MBA in Healthcare Management | VGU a degree Programs.">
...
.mobilenav img {
      ...
      <div class="row" style="margin-bottom:130px; margin: 20px;">
        <div class="col-lg-6 leftsection">
            ...
            <p style="line-height: 2;">Vivekananda Global University (VGU) offers a comprehensive Online Master of
                Business Administration (MBA) in Healthcare Management program, designed to equip students with
                essential business and leadership skills tailored to the healthcare sector. This program is ideal for
    ...
    <div class="row justify-content-center text-center">
        <div class="col-lg-8">
                    ...
                    <p class="mb-4" style="color: #ffff;">Explore the key highlights of the Online MBA-Healthcare
                        program at VGU</p>
                </div>
            </div>
