...
<head>
    ...
    <!-- Favicon -->
     ...
     <link rel="canonical" href="https://iop.onlinevgu.com/bca-artificial-intelligence/" />
    ...
    <meta name="keywords" content="BCA with AI specialization,Online BCA in artificial intelligence,AI and machine learning course in BCA,
Bachelor's in AI and computer applications,BCA AI and data intelligence program,Top AI-focused BCA course">
...
.mobilenav img {
      ...
      <div class="row" style="margin-bottom:130px; margin: 20px;">
        <div class="col-lg-6 leftsection">
            <h1 class="pb-3" style="font-family: Spectral; font-size: 40px;"><span style="font-size: 60px; color: #7f1813; font-weight: bold;">Online</span>  
                BCA-Artificial Intelligence</h1>
            ...
            <p style="line-height: 2;">Vivekananda Global University (VGU) offers a comprehensive Online Bachelor of
                Computer Applications (BCA) in Artificial Intelligence program, designed to provide students with a
                strong foundation in computer science while specializing in the rapidly evolving field of artificial
                intelligence. This program is ideal for individuals seeking flexibility in their education while
    ...
    <div class="row justify-content-center text-center">
        <div class="col-lg-8">
                    ...
                    <p class="mb-4" style="color: #ffff;">Explore the key highlights of the Online BCA-Artificial
                        Intelligence program at VGU</p>
                </div>
            </div>
