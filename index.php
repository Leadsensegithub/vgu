...
<body>
    <style>
        ...
        .applynowform textarea::placeholder{
            font-size: 12px;
        }
...
.mobilenav img {
    ...
    <div class="fables-navigation" style="display:flex; align-items: center; justify-content: space-evenly;">
    <div class="">
            <div class="row">
    ...
    <!-- Start page content -->
    <div class="container courselanding">
        <div class="row my-4 my-md-5">
            <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                <h2 class="fables-second-text-color font-35 font-weight-bold wow fadeInLeft">
                    Online VGU <span class="fables-main-text-color">Courses</span><span style="font-size:40px;">🎓</span>
                </h2>
            </div>

            <div class="col-12 col-sm-6 col-lg-6 pt-3 pt-md-5 wow zoomIn" data-wow-delay=".4s" data-wow-duration="1.5s">
                <div class="row text-center text-md-left card"
                    style="margin:10px; display: flex; align-items: center; justify-content: center; padding: 10px;box-shadow: rgb(209, 166, 164) 0px 3px 8px;height: 220px; position: relative;">
                    <div class="col-12 col-md-9 pl-md-0">
                        <h2 class="fables-main-text-color font-20 my-2 mt-md-0 semi-font"
                            style="text-align: center; color: #7f1813;font-size: 16px;"><span
                                style="font-size: 20px;">🎓</span>UG Courses</h2>
                        <div class="font-15 fables-forth-text-color" style="font-size: 14px;">
                            Explore our diverse range of Online UG programs designed to equip you with industry-relevant
                            skills and knowledge for a successful career.
                        </div>

                        <button
                            style="border: none; background-color: #7f1813; color: #ffff; border-radius: 5px; padding: 5px 10px; font-size: 13px; margin-top: 15px; margin-left: 28%;"><a
                                href="./ug" style="color: #fff;">View All Courses</a></button>

                    </div>
                    <div style="position: absolute; top: 0; right: 0;">
                        <button
                            style="border:none; background-color: #7f1813; color: #fff; padding: 5px; border-bottom-left-radius: 8px;">⭐
                            4.8</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-6 pt-3 pt-md-5 wow zoomIn" data-wow-delay="1.2s"
                ...
                <div class="row text-center text-md-left card"
                    ...
                    <div class="col-12 col-md-9 pl-md-0">
                        <h2 class="fables-main-text-color font-20 my-2 mt-md-0 semi-font"
                            style="text-align: center; color: #7f1813;font-size: 16px;"><span
                                style="font-size: 20px;">🎓</span>PG Courses</h2>
                        <div class="font-15 fables-forth-text-color" style="font-size: 14px;">
                            Our Online PG courses are designed to help you gain advanced skills and knowledge, preparing
                            you for leadership roles in your field.
                        </div>

                        <button
                            style="border: none; background-color: #7f1813; color: #ffff; border-radius: 5px; padding: 5px 10px; font-size: 13px; margin-top: 15px; margin-left: 28%;"><a
                                href="./pg" style="color: #fff;">View All Courses</a></button>
            ...
            <div class="row">
                <div class="position-relative z-index col-12 col-md-8 offset-md-2 text-center wow zoomIn"
                    ...
                    <p class="font-weight-light fables-third-text-color">
                        Join thousands of learners across India who are upgrading their careers through flexible,
                        accredited, and future-ready programs from Online VGU.
                    </p>
                    <a href="./contact"
                        class="btn fables-second-background-color white-color white-color-hover fables-btn-rounded mt-4 py-2 px-5">
                        Contact Us
                    </a>
                </div>
            </div>
