...
<body>
    <style>
       ...
       .landingvideo .video-section {
  position: relative;
  height: 100vh;
  overflow: hidden;
}

.landingvideo .bg-video {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.landingvideo .video-section .container {
  height: 100%; 
}

.landingvideo .fables-video-caption {
  color: white;
  z-index: 2;
}
...
<section class="landingvideo content-section video-section fables-after-overlay position-relative">
  <video autoplay muted loop playsinline class="bg-video">
    <source src="./assets/custom/videos/onlineVguIntro.mp4" type="video/mp4">
  </video>

  <div class="container position-relative z-index text-center d-flex justify-content-center align-items-center">
    <div class="fables-video-caption wow zoomIn" data-wow-delay="1s" data-wow-duration="2s">
      <h1 class="white-color font-weight-bold mt-6">
        Welcome to <span style="font-size:50px;"> Online VGU</span>
      </h1>
      <p class="fables-fifth-text-color mt-3 mb-4 font-18">
        Empowering your future with accredited online degrees from VGU – study anywhere, anytime.
      </p>
      <a data-fancybox href="assets/custom/videos/onlineVguIntro.mp4" class="btn" style="background-color:#7f1813; color:#ffff;">
        Watch Video
        <span class="fables-iconplay fables-second-text-color fa-4x wow bounce" style="font-size:20px; color:#ffff; display: flex; align-items: center; justify-content: 
            center; padding-top: 5px;"></span>
      </a> 
    </div>
  </div>
</section>
...
<!-- Start page content --> 
    ...
    <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
        <h2 class="font-35 font-weight-bold fables-second-text-color mb-4"><span>Online VGU</span> Courses</h2>
        <p class="fables-forth-text-color">
            At Online VGU, we offer both Undergraduate (UG) and Postgraduate (PG) degree programs designed to help you achieve academic and professional success. Our courses are flexible and provide you with the skills needed to thrive in your chosen field.
        </p>
    </div>

    <div class="col-12 col-sm-6 col-lg-4 pt-3 pt-md-5 wow zoomIn" data-wow-delay=".4s" data-wow-duration="1.5s">
        <div class="row text-center text-md-left card" style="margin:10px; display: flex; align-items: center; justify-content: center; padding: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;height: 220px;">
            <div class="col-12 col-md-9 pl-md-0">
            <h2 class="fables-main-text-color font-20 my-2 mt-md-0 semi-font" style="text-align: center; color: #7f1813;">BA</h2>
        <div class="font-15 fables-forth-text-color">
            A comprehensive program focusing on arts, humanities, and critical thinking.
        </div>
        <div>
          <button style="border: none; background-color: #7f1813; color: #ffff; border-radius: 5px; padding: 5px 10px; font-size: 13px; margin-top: 15px; margin-left: 28%;">View More</button>
          </div>
            </div>
        </div>
    </div>
       ...
       <div class="col-12 col-sm-6 col-lg-4 pt-3 pt-md-5 wow zoomIn" data-wow-delay=".8s" data-wow-duration="1.5s">
        <div class="row text-center text-md-left card" style="margin:10px; display: flex; align-items: center; justify-content: center; padding: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;height: 220px;">
            <div class="col-12 col-md-9 pl-md-0">
            <h2 class="fables-main-text-color font-20 my-2 mt-md-0 semi-font" style="text-align: center; color: #7f1813;">BBA</h2>
        <div class="font-15 fables-forth-text-color">
            A program focusing on business fundamentals, including marketing, finance, and management.
        </div>
        <button style="border: none; background-color: #7f1813; color: #ffff; border-radius: 5px; padding: 5px 10px; font-size: 13px; margin-top: 15px; margin-left: 28%;">View More</button>
    ...
    <div class="col-12 col-sm-6 col-lg-4 pt-3 pt-md-5 wow zoomIn" data-wow-delay="1.2s" data-wow-duration="1.5s">
        <div class="row text-center text-md-left card" style="margin:10px; display: flex; align-items: center; justify-content: center; padding: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;height: 220px;">
            <div class="col-12 col-md-9 pl-md-0">
            <h2 class="fables-main-text-color font-20 my-2 mt-md-0 semi-font" style="text-align: center; color: #7f1813;">BCA</h2>
        <div class="font-15 fables-forth-text-color">
            A comprehensive program focusing on computer science, programming, and application development.
        </div>
        <button style="border: none; background-color: #7f1813; color: #ffff; border-radius: 5px; padding: 5px 10px; font-size: 13px; margin-top: 15px; margin-left: 28%;">View More</button>
    ...
    <div class="col-12 col-sm-6 col-lg-4 pt-3 pt-md-5 wow zoomIn" data-wow-delay="2s" data-wow-duration="1.5s">
        <div class="row text-center text-md-left card" style="margin:10px; display: flex; align-items: center; justify-content: center; padding: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;height: 220px;">
            <div class="col-12 col-md-9 pl-md-0">
            <h2 class="fables-main-text-color font-20 my-2 mt-md-0 semi-font" style="text-align: center; color: #7f1813;">MA English</h2>
            <div class="font-15 fables-forth-text-color">
                A program focused on advanced English literature, language skills, and critical analysis.
            </div>
            <button style="border: none; background-color: #7f1813; color: #ffff; border-radius: 5px; padding: 5px 10px; font-size: 13px; margin-top: 15px; margin-left: 28%;">View More</button>
    ...
    <div class="col-12 col-sm-6 col-lg-4 pt-3 pt-md-5 wow zoomIn" data-wow-delay="2.4s" data-wow-duration="1.5s">
        <div class="row text-center text-md-left card" style="margin:10px; display: flex; align-items: center; justify-content: center; padding: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;height: 220px;">
            <div class="col-12 col-md-9 pl-md-0">
            <h2 class="fables-main-text-color font-20 my-2 mt-md-0 semi-font" style="text-align: center; color: #7f1813;">MBA</h2>
            <div class="font-15 fables-forth-text-color">
                A program focused on leadership, strategy, and business management to drive career growth.
            </div>
            <button style="border: none; background-color: #7f1813; color: #ffff; border-radius: 5px; padding: 5px 10px; font-size: 13px; margin-top: 15px; margin-left: 28%;">View More</button>
    ...
    <div class="col-12 col-sm-6 col-lg-4 pt-3 pt-md-5 wow zoomIn" data-wow-delay="2.8s" data-wow-duration="1.5s">
        <div class="row text-center text-md-left card" style="margin:10px; display: flex; align-items: center; justify-content: center; padding: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;height: 220px;">
            <div class="col-12 col-md-9 pl-md-0">
            <h2 class="fables-main-text-color font-20 my-2 mt-md-0 semi-font" style="text-align: center; color: #7f1813;">MCA</h2>
            <div class="font-15 fables-forth-text-color">
                A program that equips you with skills in data analysis, machine learning, and application development.
            </div>
            <button style="border: none; background-color: #7f1813; color: #ffff; border-radius: 5px; padding: 5px 10px; font-size: 13px; margin-top: 15px; margin-left: 28%;">View More</button>
    ...
    <div class="col-12 col-sm-6 col-lg-4 pt-3 pt-md-5 wow zoomIn" data-wow-delay="3.2s" data-wow-duration="1.5s">
        <div class="row text-center text-md-left card" style="margin:10px; display: flex; align-items: center; justify-content: center; padding: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;height: 220px;">
            <div class="col-12 col-md-9 pl-md-0">
            <h2 class="fables-main-text-color font-20 my-2 mt-md-0 semi-font" style="text-align: center; color: #7f1813;">M.A. JMC</h2>
        <div class="font-15 fables-forth-text-color">
            A program that focuses on media, communication, and journalism, preparing you for a career in the media industry.
        </div>
        <button style="border: none; background-color: #7f1813; color: #ffff; border-radius: 5px; padding: 5px 10px; font-size: 13px; margin-top: 15px; margin-left: 28%;">View More</button>
    ...
    <div class="col-12 col-sm-6 col-lg-4 pt-3 pt-md-5 wow zoomIn" data-wow-delay="2.8s" data-wow-duration="1.5s">
        <div class="row text-center text-md-left card" style="margin:10px; display: flex; align-items: center; justify-content: center; padding: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; height: 220px;">
            <div class="col-12 col-md-9 pl-md-0">
            <h2 class="fables-main-text-color font-20 my-2 mt-md-0 semi-font" style="text-align: center; color: #7f1813;">M.Sc Maths</h2>
            <div class="font-15 fables-forth-text-color">
                A program focusing on advanced mathematical concepts, data analysis, and problem-solving techniques.
            </div>
            <button style="border: none; background-color: #7f1813; color: #ffff; border-radius: 5px; padding: 5px 10px; font-size: 13px; margin-top: 15px; margin-left: 28%;">View More</button>
        ...
        <div class="row">
            <div class="position-relative z-index col-12 col-md-8 offset-md-2 text-center wow zoomIn" data-wow-duration="2s"> 
                <h3 class="white-color mb-3 font-25 font-weight-bold">
                    Empower Your Future with Online VGU 🎓
                </h3> 
