...
<head>
    ...
    <!-- Favicon -->
     ...
     <link rel="canonical" href="https://iop.onlinevgu.com/bca-data-science/" />
    ...
    <meta name="keywords" content="Online BCA in Data Science,Data science specialization in BCA,Study data science with BCA,
BCA data analytics course online,Bachelor's in data science India,Top BCA program with data science focus">
...
.mobilenav img {
    ...
    <!-- /End fables Navigation -->
      ...
      <div class="row" style="margin-bottom:130px; margin: 20px;">
        <div class="col-lg-6 leftsection">
            <h1 class="pb-3" style="font-family: Spectral; font-size: 40px;"><span style="font-size: 60px; color: #7f1813; font-weight: bold;">Online</span>   BCA-Data
                Science</h1>
            ...
            <p style="line-height: 2;">Vivekananda Global University (VGU) offers a comprehensive Online Bachelor of
                Computer Applications (BCA) in Data Science program, designed to provide students with a robust
                foundation in computer applications alongside specialized training in data science. This program is
                ideal for individuals seeking flexibility in their education while earning a degree from a
    ...
    <div class="row justify-content-center text-center">
        <div class="col-lg-8">
                    ...
                    <p class="mb-4" style="color: #ffff;">Explore the key highlights of the Online BCA-Data Science
                        program at VGU</p>
                </div>
            </div>
