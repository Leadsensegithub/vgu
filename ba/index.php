...
<head>
    ...
    <title>Explore VGU's Online BA Program: What to Expect & get admitted</title>
    <meta name="title" content="Explore VGU's Online BA Program: What to Expect and How to Get Admitted" />
    ...
    <meta name="keywords" content="Online BA degree India,Bachelor of Arts distance education,UGC-approved online BA program,BA course online with VGU,Online BA in English / Political Science / History (adjust based on specialization),Arts degree online from recognized university
,Affordable online BA degree,Best online BA courses in India,Bachelor of Arts admission 2025,Flexible BA course for working professionals,BA online learning platform India,VGU BA course details and fees,Pursue BA from home,
Online BA humanities program,Bachelor of Arts for career in civil services">
    <meta property="og:title" content="Explore VGU's Online BA Program: What to Expect & get admitted">
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cinzel:wght@400..900&family=Vollkorn:ital,wght@0,400..900;1,400..900&display=swap"
        rel="stylesheet">

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Cinzel:wght@400..900&family=Spectral:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;1,200;1,300;1,400;1,500;1,600;1,700;1,800&family=Vollkorn:ital,wght@0,400..900;1,400..900&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <style>   .applybutton{
        ...
        .courselanding .rightsection {
            background-color: #ffff;
            padding: 30px;
            box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;
        }

        .courselanding .rightsection input::placeholder,
        .courselanding .rightsection select {
            font-size: 12px;
        }
    ...
    <div class="fables-navigation"
        style="display:flex; align-items: center; justify-content: space-evenly;box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
        <div class="">
            <div class="row">
                        ...
                        <div class="mobilenav">
                            <div>
                                <a class="navbar-brand pl-0" href="../"><img
                                        src="https://iop.onlinevgu.com/assets/custom/images/vgulogo.jpeg"
                        ...
                        <div class="collapse navbar-collapse headernav" id="fablesNavDropdown">
                            ...
                            <ul class="navbar-nav mx-auto fables-nav" style="padding:10px;">
                                ...
                                <button type="button" class="pulse-button"
                                    style="margin-left: 100px; width: 150px; padding: 10px;" onClick="applynow()">Apply
                                    Now</button>
                            </ul>
    ...
    <div class="courselanding">
        <div class="row" style="margin-bottom:130px; margin: 20px;">
            <div class="col-lg-6 leftsection">
                <h1 class="pb-3" style="font-family: Spectral; font-size: 40px;"><span
                        style="font-size: 60px; color: #7f1813; font-weight: bold;">Online</span> BA</h1>
            ...
            <div class="col-lg-6 formlanding rightsection">
                <div class="">
                    ...
                    <p class="fables-main-text-color text-center mb-4 mb-md-5 font-19">Start your journey with Online
                        VGU Today <span style="font-size:20px;">🚀</span></p>

                    <form id="leadForm">
                        <div class="row applynowform">
                            <div class="col-12 col-md-6 mb-4">
                                <label for="name">Full Name:</label>
                                <input type="text" id="name" class="form-control fables-input" placeholder="Full Name"
                                    required>
    ...
    <!-- Start page content -->
    <div style="background-color: rgba(44,62,79,.8); padding: 10px; margin-top: 5%; margin-bottom: 5%;">
        <div class="container my-5">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <h2 class="font-weight-bold pb-3" style="color:#7f1813;"> Program Details</h2>
                    <p class="mb-4" style="color: #ffff;">Explore the key highlights of the Online BA program at VGU</p>
                </div>
            </div>
    ...
    <div style="background-color: rgba(44,62,79,.8); padding: 10px;">
        <div class="container my-5">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <h2 class="font-weight-bold pb-3" style="color:#7f1813;">📌 Program Highlights</h2>
                    <p class="mb-4" style="color: #ffff;">Key features that make this program stand out</p>
                </div>
            </div>
            ...
            <div class="row text-center">
                <div class="col-md-3 mb-4">
                    <div
                        style="box-shadow: 0 3px 8px rgba(0,0,0,0.1); padding: 20px; border-radius: 10px;background-color: #ffff; height: 150px;">
                        <h5 class="pb-3" style="color: #7f1813;"><span style="font-size: 22px;">🌐 </span>100% Online
                            Mode</h5>
                        <p class="mb-0">Study from anywhere at your convenience.</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 mb-4">
                    <div
                        style="box-shadow: 0 3px 8px rgba(0,0,0,0.1); padding: 20px; border-radius: 10px;background-color: #ffff; height: 150px;">
                        <h5 class="pb-3" style="color: #7f1813;"><span style="font-size: 22px;">🎓 </span>UGC-Approved
                            Degree</h5>
                        <p class="mb-0">Recognized across all sectors and institutions.</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 mb-4">
                    <div
                        style="box-shadow: 0 3px 8px rgba(0,0,0,0.1); padding: 20px; border-radius: 10px;background-color: #ffff; height: 150px;">
                        <h5 class="pb-3" style="color: #7f1813;"><span style="font-size: 22px;">📚
                            </span>Industry-Aligned Curriculum</h5>
                        <p class="mb-0">Courses designed to meet modern industry needs.</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 mb-4">
                    <div
                        style="box-shadow: 0 3px 8px rgba(0,0,0,0.1); padding: 20px; border-radius: 10px;background-color: #ffff; height: 150px;">
                        <h5 class="pb-3" style="color: #7f1813;"><span style="font-size: 22px;">👨‍🏫 </span>Expert
                            Faculty</h5>
                        <p class="mb-0">Learn from experienced professors and mentors.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-3 mb-4 mb-lg-0">
                    <a href="#" class="fables-second-border-color border-bottom pb-3 d-block mb-3 mt-minus-13"><img
                            src="https://iop.onlinevgu.com/assets/custom/images/vgulogo.jpeg" alt="fables template"
