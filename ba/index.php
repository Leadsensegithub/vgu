...
<head>
    ...
    <meta name="description" content="Begin your academic journey with VGU's Online BA Degree�develop innovative thinking, broad views, and adaptive learning skills for a well-rounded destiny.">
...
<meta property="og:description" content="Begin your academic journey with VGU's Online BA Degree develop innovative thinking, broad views, and adaptive learning skills for a well-rounded destiny.">
     ...
     <div class="courselanding">
      <div class="row" style="margin-bottom:130px; margin: 20px;">
        <div class="col-lg-6 leftsection">
            <h2 class="pb-3" style="font-family: Spectral; font-size: 40px;"><span style="font-size: 60px; color: #7f1813; font-weight: bold;">Online</span>  BA</h2>
            <h3 class="pb-4" style="font-family: Vollkorn;">Vivekananda Global University</h3>
            <p style="line-height: 2;">Vivekananda Global University (VGU) offers a comprehensive Online Bachelor of Arts (BA) program designed
                to provide students with a solid foundation in the humanities and social sciences. This program is ideal
...
<div style="background-color: rgba(44,62,79,.8); padding: 10px; margin-top: 5%; margin-bottom: 5%;">
    ...
    <div class="row justify-content-center text-center">
        <div class="col-md-4 mb-4">
            <div style="box-shadow: 0 3px 10px rgba(0,0,0,0.1); padding: 20px; border-radius: 8px;background-color: #ffff;">
...
<div class="row mt-3 mt-lg-5">
    ...
    <div class="row text-center">
        <div class="col-md-3 mb-4">
            <div style="box-shadow: 0 3px 8px rgba(0,0,0,0.1); padding: 20px; border-radius: 10px;background-color: #ffff; height: 150px;">
                <h5 class="pb-3" style="color: #7f1813;"><span style="font-size: 22px;">🌐 </span>100% Online Mode</h5>
        ...
        <div class="col-md-3 mb-4">
            <div style="box-shadow: 0 3px 8px rgba(0,0,0,0.1); padding: 20px; border-radius: 10px;background-color: #ffff; height: 150px;">
                <h5 class="pb-3" style="color: #7f1813;"><span style="font-size: 22px;">🎓 </span>UGC-Approved Degree</h5>
        ...
        <div class="col-md-3 mb-4">
            <div style="box-shadow: 0 3px 8px rgba(0,0,0,0.1); padding: 20px; border-radius: 10px;background-color: #ffff; height: 150px;">
                <h5 class="pb-3" style="color: #7f1813;"><span style="font-size: 22px;">📚 </span>Industry-Aligned Curriculum</h5>
        ...
        <div class="col-md-3 mb-4">
            <div style="box-shadow: 0 3px 8px rgba(0,0,0,0.1); padding: 20px; border-radius: 10px;background-color: #ffff; height: 150px;">
                <h5 class="pb-3" style="color: #7f1813;"><span style="font-size: 22px;">👨‍🏫 </span>Expert Faculty</h5>
