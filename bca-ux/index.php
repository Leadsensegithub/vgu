...
<head>
    ...
    <!-- Favicon -->
     ...
     <link rel="canonical" href="https://iop.onlinevgu.com/bca-ux/" />
    ...
    <meta name="keywords" content="Online BCA in UX Design,BCA with user experience specialization,UX design course with BCA,
Learn UX design online India,Bachelors in UX and interface design,BCA in UI/UX development">
...
.mobilenav img {
    ...
    <!-- /End fables Navigation -->
      ...
      <div class="row" style="margin-bottom:130px; margin: 20px;">
        <div class="col-lg-6 leftsection">
            <h1 class="pb-3" style="font-family: Spectral; font-size: 40px;"><span style="font-size: 60px; color: #7f1813; font-weight: bold;">Online</span>   BCA-UX</h1>
            ...
            <p style="line-height: 2;">Vivekananda Global University (VGU) offers a comprehensive Online Bachelor of
                Computer Applications (BCA) in User Experience (UX) Design program, designed to provide students with a
                solid foundation in computer applications while focusing on the principles and practices of user-centric
                design. This program is ideal for individuals seeking flexibility in their education while pursuing a
    ...
    <div class="row justify-content-center text-center">
        <div class="col-lg-8">
                    ...
                    <p class="mb-4" style="color: #ffff;">Explore the key highlights of the Online BCA-UX program at VGU
                    </p>
                </div>
            </div>
