...
<head>
    ...
    <!-- Favicon -->
     ...
     <link rel="canonical" href="https://iop.onlinevgu.com/msc-mathematics/" />
    <title>VGU Online MSc in Mathematics: Certified Postgraduate STEM Degree</title>
    <meta name="title" content="VGU Online MSc in Mathematics: Certified Postgraduate STEM Degree" />
    <meta name="description"
        content="Advance your career with VGU's Online MSc in Mathematics. Develop analytical and mathematical abilities to thrive in the finance, IT, and research industries">
    <meta name="keywords" content="Online M.Sc. Mathematics,MSc Mathematics distance education,
Master of Science in Mathematics,Postgraduate math degree online,Mathematics online degree India,
Best online MSc Mathematics program,VGU online M.Sc. Maths,M.Sc. Mathematics admission 2025,UGC-approved online MSc Mathematics,
Study MSc Maths from home,Top online university for MSc Maths,MSc Mathematics course details,
Career after MSc Mathematics,Flexible MSc Maths program online">
    <meta property="og:title" content="VGU Online MSc in Mathematics: Certified Postgraduate STEM Degree">
...
.mobilenav img {
    ...
    <!-- /End fables Navigation -->
      ...
      <div class="row" style="margin-bottom:130px; margin: 20px;">
        <div class="col-lg-6 leftsection">
            <h1 class="pb-3" style="font-family: Spectral; font-size: 40px;"><span style="font-size: 60px; color: #7f1813; font-weight: bold;">Online</span>  
                MSC-Mathematics</h1>
            ...
            <p style="line-height: 2;">Vivekananda Global University (VGU) offers a comprehensive Online Master of
                Science (MSc) in Mathematics program, designed to provide students with advanced mathematical knowledge
                and analytical skills. This program is ideal for individuals seeking flexibility in their postgraduate
                education while earning a degree from a UGC-recognized institution.​</p>
    ...
    <div class="row justify-content-center text-center">
        <div class="col-lg-8">
                    ...
                    <p class="mb-4" style="color: #ffff;">Explore the key highlights of the Online MSC-Mathematics
                        program at VGU</p>
                </div>
            </div>
